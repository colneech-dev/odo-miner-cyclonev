...
/* Physical base address for /dev/mem mapping. */
#define FPGA_BASE            (LWHPS2FPGA_BASE + MINER_BASE_OFFSET)

/* Size of the region we mmap (one 4 KiB page is plenty for the regs) */
#define MINER_SPAN           0x00001000UL
#define FPGA_SPAN            MINER_SPAN
...
#define REG_STATUS           0x004   /* R: bit0=busy, bit1=found, bit2=core_ready */
