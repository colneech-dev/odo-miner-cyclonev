...
try {
    ...
    $bin  = wsl wslpath -a "C:/Users/Colin/Documents/GitHub/odo-miner-cyclonev/deploy-staging/odo-miner-pipe"
    $init = wsl wslpath -a "C:/Users/Colin/Documents/GitHub/odo-miner-cyclonev/deploy-staging/S90odod"
